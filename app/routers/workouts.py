...
def add_template_item(
   ...
   return svc.add_template_item(db=db, user_id=user.id, template_id=template_id, payload=payload)
...
def update_template_item(
   ...
   return svc.update_template_item(db=db, user_id=user.id, item_id=item_id, payload=payload)
...
def make_session_from_template(
   ...
   return svc.make_session_from_template(db=db, user_id=user.id, template_id=template_id, session_date=session_date, title=title, notes=notes)
